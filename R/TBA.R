...
#'
#' @description
#' This function calculates the Targeted Biomass Adjustment (TBA), which dampens the influence of biomass indices on catch advice when the proportion of abundance targeted by harvest slot limits is small.
#'
#' @param P_targeted The proportion of abundance targeted by harvest slot limits, calculated using the `prop_target` function.
...
#' TBA(P_targeted, rB)
#'
#' @seealso \code{\link{prop_target}} # for the proportion of abundance targeted by HSL
